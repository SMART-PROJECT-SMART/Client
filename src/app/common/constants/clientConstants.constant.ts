export namespace ClientConstants {
  ...
  export namespace AssignmentReviewMap {
    ...
    export const UAV_SCORE_BADGE_BG_COLOR = '#fdd835';
    export const UAV_SCORE_BADGE_TEXT_COLOR = '#111827';
    export const UAV_SCORE_BADGE_MIN_WIDTH_PX = 30;
    export const UAV_SCORE_BADGE_HEIGHT_PX = 14;
    export const UAV_SCORE_BADGE_FONT_SIZE_PX = 9;
