export namespace ClientConstants {
  ...
  export namespace TelemetryUnits {
    ...
    export const FUEL_AMOUNT: string = 'kg';
    export const AMMO_PERCENTAGE: string = 'rounds';
  ...
  export namespace AssignmentReviewMap {
    ...
    export const UAV_SCORE_BAND_HIGH = 'high';
    export const UAV_SCORE_BAND_MEDIUM = 'medium';
    export const UAV_SCORE_BAND_LOW = 'low';
    export const UAV_SCORE_BADGE_HIGH_BG_COLOR = '#2e7d32';
    export const UAV_SCORE_BADGE_HIGH_TEXT_COLOR = '#ffffff';
    export const UAV_SCORE_BADGE_MEDIUM_BG_COLOR = '#f9a825';
    export const UAV_SCORE_BADGE_MEDIUM_TEXT_COLOR = '#111827';
    export const UAV_SCORE_BADGE_LOW_BG_COLOR = '#d32f2f';
    export const UAV_SCORE_BADGE_LOW_TEXT_COLOR = '#ffffff';
    export const UAV_SCORE_BADGE_MIN_WIDTH_PX = 32;
    export const UAV_SCORE_BADGE_HEIGHT_PX = 18;
    export const UAV_SCORE_BADGE_FONT_SIZE_PX = 11;
    export const UAV_SCORE_BADGE_OFFSET_TOP_PX = -5;
    export const UAV_SCORE_BADGE_OFFSET_LEFT_PX = -6;
    export const UAV_SCORE_BADGE_ARIA_LABEL = 'Relative score';
    export const TOOLTIP_RELATIVE_SCORE_SECTION_TITLE = 'Tactical score';
    export const TOOLTIP_RELATIVE_SCORE_LABEL = 'Relative score';
    export const TACTICAL_SCORE_SUFFIX = '%';
    export const TACTICAL_SCORE_BADGE_DECIMALS = 0;
    export const TACTICAL_SCORE_TOOLTIP_DECIMALS = 2;
