import { Component, output, input, OnInit, signal, ChangeDetectionStrategy, DestroyRef } from '@angular/core';
...
export class MissionComponentComponent implements OnInit {
  ...
  public ngOnInit(): void {
    ...
    this.missionForm.valueChanges.pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => {
